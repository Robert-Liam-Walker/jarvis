...
`runs/`; that folder is ignored by Git. API keys saved through `1-Baslat.cmd` are
...
them. Move the mouse to the upper-left corner or use `0-Durdur.cmd` to request a
