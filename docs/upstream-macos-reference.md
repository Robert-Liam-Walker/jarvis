# Upstream macOS reference

The following material is retained from the original macOS project. Its cost,
latency, accessibility coverage, API pricing and model comparisons are historical
upstream claims, not measurements of this Windows port or current pricing guidance.
AppleScript, Quartz, AX and Vision descriptions apply to the macOS backend.
For the Windows runtime, installation and measured limits, use [WINDOWS.md](../WINDOWS.md).

[Upstream source at the fork base](https://github.com/awlevin/typesafe-computer-use/tree/cc7b5066ae1a07b5e3182e8f87a9b5b6dfdcffc1).
